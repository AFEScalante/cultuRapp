...
ui <- fluidPage(
  ...
  column(
    ...
    div(style="display: inline-block;vertical-align:left; width: 130px;
        color: white;",
        br(),
        h2("cultuRa CDMX"), align = "left"),
    br(), br(),
    div(style="color: gray;",
        h3("Puntos culturales dentro de la Ciudad de México")),
    div(style="color: gray; width: 335px; align: left; margin-left: 50px;",
        p(align = "left", "Esta aplicación muestra un mapa con todos los puntos culturales según el SIC México (Sistema de Información Cultural) extraído al 20/12/2021.")),
    br(), br(),
